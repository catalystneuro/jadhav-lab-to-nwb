...
from ..common.tools.spikeinterface import MultiRecordingDataChunkIterator
...
class Olson2024SingleEpochSpikeGadgetsRecordingInterface(SpikeGadgetsRecordingInterface):
    ...
    def add_to_nwbfile(
        ...
        from ..common.tools.spikeinterface import add_recording_to_nwbfile, get_electrical_series_kwargs
